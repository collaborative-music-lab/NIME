...
#
#Adds support for ultrasonic sensor
...
######################
# Available modes:
# MEAN: returns average of sensor readings
# MEDIAN: returns median of sensor values - good for ignoring spikes
# MIN/MAX: returns min or maximum, good for detecting changes in digital value/state
# PEAK_DEVIATION: returns change since last sensor reading
# CAP_SENSE: uses ESP32 built-in capsense on specified piin
# TRIG & ECHO: used for ultrasonic sensor. returns microsecond reading
