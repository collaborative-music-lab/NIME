...
######################
OSC_ADDRESSES = {
    27:{ 'address':'/analog0', 'enable': 1, 'rate':100, 'mode':'CAP_SENSE' },
    33:{ 'address':'/analog1', 'enable': 0, 'rate':20, 'mode':'MEAN' },
    32:{ 'address':'/analog2', 'enable': 0, 'rate':50, 'mode':'MEAN' },
    ...
    35:{ 'address':'/button1', 'enable': 0, 'rate':15, 'mode':'MEAN' }
}
