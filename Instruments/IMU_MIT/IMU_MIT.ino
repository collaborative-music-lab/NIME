...
//set kerb and PW directly in m370_communications.py
//below are just placeholders
const char * ssid = "MIT SECURE"; //2.4GHz network only (no 5g)
const char * kerb = "yourkerb@mit.edu"; //your full MIT kerb with @mit.edu
const char * password = "pw"; //your MIT password
const char * port = "1234"; //must match port in python comms declaration line 17
