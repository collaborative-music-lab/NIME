/*!
    ...
    Heavily based on the  Adafruit_MPR121 library by Limor Fried
    Modifications:
    -  added   constructor with  option to set SCL and SDA
...
#ifndef M370_MPR121_H
#define M370_MPR121_H
...
class  m370_MPR121 {
  public:
    ...
    // Hardware I2C
    m370_MPR121();
    m370_MPR121(byte _SDA, byte _SCL);
