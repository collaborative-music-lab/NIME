/* 370_ALL_ANALOG
 *  
 * Sends values from all analog pins
 *  
 *   
 * _______
 * 
...
Sensor analog_0( p0,"/analog/0", analogSendRate, 2, MEAN );
Sensor analog_1( p1,"/analog/1", analogSendRate, 2, MEAN );
Sensor analog_2( p2,"/analog/2", analogSendRate, 2, MEAN );
Sensor analog_3( p3,"/analog/3", analogSendRate, 2, MEAN );
Sensor analog_4( p4,"/analog/4", analogSendRate, 2, MEAN );
Sensor analog_5( p5,"/analog/5", analogSendRate, 2, MEAN );
Sensor analog_6( p6,"/analog/6", analogSendRate, 2, MEAN );
Sensor analog_7( p7,"/analog/7", analogSendRate, 2, MEAN );
Sensor analog_8( p8,"/analog/8", analogSendRate, 2, MEAN );
Sensor analog_9( p9,"/analog/9", analogSendRate, 2, MEAN );
